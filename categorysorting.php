...
function foxyshop_category_sorting_menu() {    
	add_submenu_page('edit.php?post_type=foxyshop_product', __('Category Sorting'), __('Set Category Order'), 'manage_options', 'foxyshop_category_sort', 'foxyshop_category_sort');
}
