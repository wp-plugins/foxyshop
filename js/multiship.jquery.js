    ...
    */
    ...
    function shipto_select() {
    	...
    	jQuery('div.shipto_select').find('select').html('');
    	var shipto_options = '';
    	...
    	if (shipto) {
    		...
    		jQuery.each(shipto, function(i, val){
    			...
    			if (val != 'null' && val != '' && val != 'me') {
    				shipto_options += '<option displaykey="shipto" value="' + val + '">' + val + '<\/option>';
    	...
    	jQuery('div.shipto_select').find('select').html(shipto_options);
     
    	// Now add the onchange event
    	jQuery('div.shipto_select').find('select').change(function(){
    	...
    	if (jQuery.cookie('shipto_name_recent') != '') {
    		jQuery('div.shipto_select').find('select').selectOptions(jQuery.cookie('shipto_name_recent'));
    	} else {
    		jQuery('div.shipto_select').find('select').selectOptions('me');
    	}
    }
