...
class FoxyShop_Category extends WP_Widget {
	...
	function FoxyShop_Category() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'foxyshop_category', 'description' => __('Show the contents of a FoxyShop product category.', 'fs_category') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'foxyshop-category-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'foxyshop-category-widget', __('FoxyShop Category', 'fs_category'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- Select Category -->
		<p>
			<label for="<?php echo $this->get_field_id( 'categoryName' ); ?>"><?php _e('Category:', 'fs-category'); ?></label> 
		...
		<!-- Max Entries -->
		<p>
			<label for="<?php echo $this->get_field_id( 'showMax' ); ?>"><?php _e('Max Products to Show:', 'fs-max-products-to-show'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'simpleView' ); ?>"><?php _e('Show Simple View', 'fs-show-simple-view'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'showAddToCart' ); ?>"><?php _e('Show Add To Cart Button', 'fs-add-cart-button'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'showMoreDetails' ); ?>"><?php _e('Show More Details Button', 'fs-show-more-details-button'); ?></label>
		</p>
...
class FoxyShop_Cart_Link extends WP_Widget {
	...
	function FoxyShop_Cart_Link() {
		$widget_ops = array( 'classname' => 'foxyshop_cart_link', 'description' => __('Show a link to view shopping cart.', 'fs_cart_link') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'foxyshop-cart-link-widget' );
		$this->WP_Widget( 'foxyshop-cart-link-widget', __('FoxyShop Cart Link', 'fs_cart_link'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- Max Entries -->
		<p>
			<div><?php _e('Link Text:', 'fs_link_text'); ?></div>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'hideEmpty' ); ?>"><?php _e('Hide Link if Cart is Empty', 'fs-hide-empty'); ?></label>
		</p>
