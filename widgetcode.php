...
function foxyshop_order_history_dashboard_ajax() {
	...
	echo '<li>' . __('One Day', 'foxyshop') . ': <a href="edit.php?foxyshop_search=1&amp;is_test_filter=&amp;post_type=foxyshop_product&amp;page=foxyshop_order_management&amp;transaction_date_filter_begin=' . date("Y-m-d", strtotime("-1 day")) . '&amp;transaction_date_filter_end='.date("Y-m-d") . '">' . $orderstats[1][0] . ' ' . ($orderstats[1][0] == 1 ? __('order', 'foxyshop') : __('orders', 'foxyshop')) . ', ' . foxyshop_currency($orderstats[1][1]) . '</a></li>'."\n";
	echo '<li>' . __('Seven Days', 'foxyshop') . ': <a href="edit.php?foxyshop_search=1&amp;is_test_filter=&amp;post_type=foxyshop_product&amp;page=foxyshop_order_management&amp;transaction_date_filter_begin=' . date("Y-m-d", strtotime("-7 days")) . '&amp;transaction_date_filter_end='.date("Y-m-d") . '">' . $orderstats[7][0] . ' ' . ($orderstats[7][0] == 1 ? __('order', 'foxyshop') : __('orders', 'foxyshop')) . ', ' . foxyshop_currency($orderstats[7][1]) . '</a></li>'."\n";
	echo '<li>' . __('30 Days', 'foxyshop') . ': <a href="edit.php?foxyshop_search=1&amp;is_test_filter=&amp;post_type=foxyshop_product&amp;page=foxyshop_order_management&amp;transaction_date_filter_begin=' . date("Y-m-d", strtotime("-30 days")) . '&amp;transaction_date_filter_end='.date("Y-m-d") . '">' . $orderstats[30][0] . ' ' . ($orderstats[31][0] == 1 ? __('order', 'foxyshop') : __('orders', 'foxyshop')) . ', ' . foxyshop_currency($orderstats[30][1]) . '</a></li>'."\n";
	die;
}
?>