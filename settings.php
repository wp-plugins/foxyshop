...
<div id="foxyshop_settings_wrap">
	...
	<p>For more information on FoxyShop and complete documentation, please visit <a href="http://www.foxy-shop.com/" target="_blank">www.foxy-shop.com</a>.<br />
	If you need a FoxyCart account, please <a href="http://affiliate.foxycart.com/idevaffiliate.php?id=211" target="_blank">click here</a>.</p>
	...
	<table class="widefat">
		<thead>
			<tr>
				<th>FoxyCart Settings</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td>
					<label for="foxyshop_domain">Your Complete FoxyCart Domain:</label> <input type="text" name="foxyshop_domain" value="<?php echo $foxyshop_settings['domain']; ?>" size="50" /> (example: yourname.foxycart.com)
					<div class="small">If you have your own custom domain, you may enter that as well (cart.yourname.com). Do not include the "http://".</div>
				</td>
			</tr>
			<tr>
				<td>
					<label for="foxyshop_key">Product Verification API Key:</label>
			...
			<tr>
				<td>
					<label for="foxyshop_ship_categories" style="vertical-align: top;">Your Shipping Categories:</label>
					...
					<div class="small">These categories should correspond to the category codes you set up in your FoxyCart admin and will be available in a drop-down on your product setup page. Separate by line break. If you only use one main, default category this is not required.</div>
				</td>
			</tr>
			<tr>
				<td>
					<label for="foxyshop_version">FoxyCart Version:</label> 
		...
		<tbody>
			<tr>
				<td>
					...
					<label for="foxyshop_shipto">Enable Multiple Shipping Recipients</label>
					<div class="small">Remember that FoxyCart charges an extra fee for this service. You must enable it on your FoxyCart account or it will not work.</div>
				</td>
			</tr>
			<tr>
				<td>
					...
					<label for="foxyshop_enable_custom_file_uploads">Enable Custom File Uploading</label>
					<div class="small">Allow customers to upload custom files as a product variation.</div>
				</td>
			</tr>
			<tr>
				<td>
					...
					<label for="foxyshop_enable_bundled_products">Enable Bundled Products</label>
					<div class="small">Allow multiple items to be added to the cart at once (extra items will be added with a price of $0.00)</div>
				</td>
			</tr>
			<tr>
				<td>
					...
					<label for="foxyshop_enable_subscriptions">Enable Subscriptions</label>
					<div class="small">Show fields to allow the creation of subscription products.</div>
				</td>
			</tr>
			<tr>
				<td>
					<span>Default Weight Type:</span>
					...
					<label for="foxyshop_weight_type_english">English</label>
					...
					<label for="foxyshop_weight_type_metric">Metric</label>
				</td>
			</tr>
			<tr>
				<td>
					<label for="foxyshop_default_weight">Default Weight:</label> <input type="text" id="foxyshop_default_weight" name="foxyshop_default_weight" value="<?php echo $foxyshop_settings['default_weight']; ?>" size="10" /> (lbs/kg)
				</td>
			</tr>
			<tr>
				<td>
					<label for="foxyshop_max_variations">Maximum Variations:</label> <input type="text" id="foxyshop_max_variations" name="foxyshop_max_variations" value="<?php echo $foxyshop_settings['max_variations']; ?>" size="10" />
					<div class="small">This is an arbitrary number to save resources and should cover you in most cases. Raise it only if you need to.</div>
				</td>
			</tr>
			<tr>
				<td>
					<label for="foxyshop_ga">Google Analytics Code:</label> <input type="text" id="foxyshop_ga" name="foxyshop_ga" value="<?php echo $foxyshop_settings['ga']; ?>" size="20" />
					<div class="small">Enter your UA code here (example: UA-XXXXXXXX-X) and Google Analytics tracking will be installed in the footer. Additionally, it will only run if the visitor is not a logged-in WordPress user so that admin usage won't be tracked.</div>
				</td>
			</tr>
			<tr>
				<td>
					<label for="foxyshop_default_image">Default Image:</label> <input type="text" id="foxyshop_default_image" name="foxyshop_default_image" value="<?php echo $foxyshop_settings['default_image']; ?>" size="100" />
					<div class="small">Enter the URL for the image that will be shown if no image is loaded. Or leave the default, it's up to you. (If you change the website URL, though, you'll have to come back and change it here.)</div>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="widefat">
		...
		<tbody>
			<tr>
				<td>
					If you would like to <a href="http://www.google.com/merchants" target="_blank">submit your products to Google</a>, you may do so by copying and pasting the contents of this box into a txt file and submitting it.
